...
curl http://${node_one_ip}:3033/testnet3/program/credits.aleo/mapping/account/aleo1p9sg8gapg22p3j42tang7c8kqzp4lhe6mg77gx32yys2a5y7pq9sxh6wrd
...
do
    ...
    snarkos developer execute credits.aleo transfer_public ${addresses[i]} 30000000000000u64 --private-key ${private_keys[$key_index]} --query http://${node_one_ip}:3033 --broadcast "http://${node_one_ip}:3033/testnet3/transaction/broadcast"
done
