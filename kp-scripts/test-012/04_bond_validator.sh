...
#sleep 20
#snarkos developer execute credits.aleo bond_public "${addresses[val_index]}" 1200000000000u64 --private-key "${private_keys[val_index]}" --query "http://localhost:3032" --broadcast "http://localhost:3032/testnet3/transaction/broadcast"
snarkos developer execute credits.aleo bond_public "${addresses[val_index]}" 18750000000000u64 --private-key "${private_keys[val_index]}" --query "http://localhost:3032" --broadcast "http://localhost:3032/testnet3/transaction/broadcast"
