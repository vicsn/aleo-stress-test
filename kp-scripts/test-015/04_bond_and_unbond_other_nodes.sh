...
do
    ...
    snarkos developer execute credits.aleo unbond_public 186300000000000u64 --private-key ${private_keys[i]} --query http://${node_one_ip}:3033 --broadcast http://${node_one_ip}:3033/testnet3/transaction/broadcast
done
